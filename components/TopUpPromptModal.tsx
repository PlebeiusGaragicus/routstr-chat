...
const TopUpPromptModal: React.FC<TopUpPromptModalProps> = ({
  ...
  const modalContent = (
    <div className="space-y-4">
      <h2 className="text-xl font-semibold text-foreground">Top Up</h2>
      ...
      <div className="">
        ...
        {activeTab === "lightning" && (
          <div className="space-y-4">
            {/* QR / placeholder */}
            <div className="bg-muted/50 border border-border p-6 rounded-lg flex items-center justify-center">
              <div
                className={`w-48 h-48 flex items-center justify-center p-2 rounded-lg ${
                  invoice ? "cursor-pointer hover:bg-muted transition-all" : ""
                }`}
            ...
            {invoice && (
              <button
                ...
                className="w-full px-4 py-2 text-sm bg-muted/50 hover:bg-muted border border-border rounded-lg text-foreground transition-all"
                type="button"
              >
                Copy Invoice
              </button>
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 bg-muted/50 border border-border rounded-lg px-4 py-2.5 text-sm text-foreground placeholder:text-muted-foreground focus:border-ring focus:outline-none focus:ring-1 focus:ring-ring transition-all"
              />
              <button
                onClick={() => {
                  void handleCreateInvoice();
                }}
                className="bg-muted/50 hover:bg-muted border border-border text-foreground px-4 py-2.5 rounded-lg text-sm font-medium transition-all cursor-pointer"
                type="button"
              >
                {isProcessing ? (
      ...
      {successMessage && (
        <div className="bg-green-500/10 border border-green-500/30 text-green-200 p-3 rounded-lg text-sm">
          {successMessage}
        </div>
      )}
      ...
      <div className="relative py-1">
        ...
        <div className="relative flex justify-center">
          <span className="bg-card px-1 text-lg font-bold text-foreground/90">
            OR
          </span>
        </div>
      </div>
  ...
  return (
    ...
    >
      <div className="bg-card border border-border rounded-md p-5 max-w-sm w-full relative">
        <button
          onClick={onClose}
